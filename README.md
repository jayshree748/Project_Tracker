...
1. **Prepare MongoDB Atlas**: [See MONGODB_ATLAS_SETUP.md](./MONGODB_ATLAS_SETUP.md)
2. **Deploy Backend to Railway**: [See DEPLOYMENT_GUIDE.md](./DEPLOYMENT_GUIDE.md)
3. **Deploy Frontend to Vercel**: [See DEPLOYMENT_GUIDE.md](./DEPLOYMENT_GUIDE.md)
4. **Connect Frontend & Backend**: Update environment variables
5. **Test Production**: Visit deployed frontend URL
...
- Local: mongodb://localhost:27017/project-tracker
...
```
Solution: Check JWT_SECRET matches in backend .env
```
...
```
Solution: Check localStorage.getItem("token") in browser
```
...
# First commit
git commit -m "Initial commit: Full-stack Project Tracker"

# Add GitHub remote
git remote add origin https://github.com/YOUR_USERNAME/Project_Tracker_ProjectAI.git

# Push to GitHub
git push -u origin main
```

See [ENVIRONMENT_SETUP.md](./ENVIRONMENT_SETUP.md) for detailed Git instructions.
...
2. Check [MONGODB_ATLAS_SETUP.md](./MONGODB_ATLAS_SETUP.md)
3. Check [ENVIRONMENT_SETUP.md](./ENVIRONMENT_SETUP.md)
...
- 💻 GitHub: `https://github.com/YOUR_USERNAME/Project_Tracker_ProjectAI`
